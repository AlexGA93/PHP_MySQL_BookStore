...
if(isset($_POST['send'])){
   ...
   $take_message_query = "SELECT * FROM `message` WHERE name = '$name' AND email = '$email' AND number = '$number' AND message = '$msg'";
   ...
   if(mysqli_num_rows($select_message) > 0){
    ...
    $insert_message_query = "INSERT INTO `message`(user_id, name, email, number, message) VALUES('$user_id', '$name', '$email', '$number', '$msg')";
      mysqli_query(
        $conn,
